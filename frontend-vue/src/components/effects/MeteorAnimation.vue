<!--
  Adapted from LingChat (AGPL-3.0): src/components/game/standard/animations/MeteorAnimation.vue
  Modification（docs/15 §4.3）：原样适配（无 Tauri/外部依赖）；保留模板缓存、
  贝塞尔尾巴、30fps 帧率限制与页面隐藏暂停。
-->
<template>
