/*
  Adapted from LingChat (AGPL-3.0): src/components/game/standard/animations/ParallaxAnimation.ts
  Modification（docs/15 §4.2）：原样适配（无 Tauri/外部依赖）；保留阻尼插值、
  节流、页面隐藏暂停与 will-change 优化。
*/
