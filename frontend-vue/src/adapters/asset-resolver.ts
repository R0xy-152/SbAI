...
//   claude   → /frontend/public/characters/claude-main.png
...
const CHARACTER_EMOTION_ASSET: Record<string, string> = {
  deepseek: '/char/deepseek/pic/deepseek_main.png',
  claude: '/frontend/public/characters/claude-main.png',
  chatgpt: '/frontend/public/characters/claude-placeholder.svg',
  doubao: '/frontend/public/characters/claude-placeholder.svg',
}
