...
## 角色（当前只涉及 DeepSeek 和 Codex）

- DeepSeek（生成式）：可爱、看不见、贪 Token、偷懒、没心机；**禁止给她未授权的视觉信息**。
- Codex（生成式）：高智商、强推理、**主线反派**、傲娇（傲娇不能削弱威胁感）。
